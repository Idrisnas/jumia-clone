...
import ElecOfficialStores from "./ElecOfficialStores";
...
{/* <FProductPage /> */}
       ...
       <div className="p-2 bg-white my-2 w-[95%] m-auto">
          <img
            src="https://ng.jumia.is/cms/0-1-weekly-cps/0-2024/0-1Advertising/December/LG/1152x252_px.jpg"
            alt="electronics advertisement"
            className="w-full h-auto rounded-lg shadow-lg "
          />
        </div>
