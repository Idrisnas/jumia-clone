...
const ItelStores = () => {
    ...
    return (
      <div className=" m-auto w-[95%] mt-1 ">
        <div className=' p-2 flex justify-between items-center bg-blue-900 font-semibold text-xl mb-0 text-white'>
       
       <p className="text-2xl">Itel Official Store</p>
