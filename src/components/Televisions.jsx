  ...
  return (
    <div>
      ...
      <div className="bg-white p-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 m-auto w-[95%] text-white">
        ...
        <Link className="flex flex-col items-center hover:scale-105 transition-transform duration-300 relative">
          <img
            src="https://ng.jumia.is/cms/0-1-category-pages/electronics/0-televisions/23-32-inch-tvs_300x400.png"
            alt="Clearance Sale"
            className="w-full h-auto rounded-lg shadow-lg"
          />
        ...
        <Link className="flex flex-col items-center hover:scale-105 transition-transform duration-300 relative">
          <img
            src="https://ng.jumia.is/cms/0-1-category-pages/electronics/0-televisions/39-43-inch-tvs_300x400.png"
            alt="Appliance Deals"
            className="w-full h-auto rounded-lg shadow-lg"
          />
        ...
        <Link className="flex flex-col items-center hover:scale-105 transition-transform duration-300 relative">
          <img
            src="https://ng.jumia.is/cms/0-1-category-pages/electronics/0-televisions/55-75-inch-tvs_300x400.png"
            alt="Up to 50% off"
            className="w-full h-auto rounded-lg shadow-lg"
          />
        ...
        <Link className="flex flex-col items-center hover:scale-105 transition-transform duration-300 relative">
          <img
            src="https://ng.jumia.is/cms/0-1-category-pages/electronics/0-televisions/85-inch-above_300x400.png"
